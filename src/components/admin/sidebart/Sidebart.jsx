      ...
      <nav className="mt-6">
        ...
        <Link to={'/admin/students'}>
          ...
          >
            ...
            {!collapsed && <span className="ml-4">Quản lí học viên</span>}
          </div>
        </Link>
        <Link to={'/admin/teachers'}>
          ...
          >
            ...
            {!collapsed && <span className="ml-4">Quản lí giáo viên</span>}
          </div>
        </Link>
        <Link to={'/admin/courses'}>
          ...
          >
            ...
            {!collapsed && <span className="ml-4">Quản lí khóa học</span>}
          </div>
        </Link>
