...
//                     <div
//                         key={deck._id}
//                         className="w-full flex items-center justify-between p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
//                     >
...
function ManageFlashcard() {
    ...
    const visibleDecks = filteredDecks?.slice(0, visibleItems)
    console.log('visibleDecks', visibleDecks)
    const hasMore = filteredDecks?.length > visibleItems
