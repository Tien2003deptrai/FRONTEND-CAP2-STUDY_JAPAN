...
//         return (
//             <div className="text-center py-10 text-red-600">
//                 Không tìm thấy kết quả bài thi. Vui lòng quay lại trang trước.
//             </div>
//         )
//     }

//     const result = {
//         examTitle: res.examTitle || 'Đề thi không xác định',
//         examId: res.examId,
//         totalScore: res.totalScore,
//         time: res.timeSpent ? `${res.timeSpent} giây` : null,
//         answers: res.scoredAnswers.map((a) => ({
...
//                     <button
//                         onClick={() =>
//                             navigate(`/practice/exam/${res.examId}`)
//                         }
//                         className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg transition"
//                     >
//                         📄 Xem chi tiết đề thi
