...
const MainDash = () => {
  ...
  const recentContent = [
    ...
    { id: 2, title: 'Kanji N4 - Tập 3', type: 'Bài học', date: '14/03/2025' },
    { id: 3, title: 'Luyện nghe JLPT N3', type: 'Video', date: '13/03/2025' },
    {
      id: 4,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b border-gray-200">
            <h3 className="text-lg font-semibold">Học viên gần đây</h3>
          </div>
          <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b border-gray-200">
            <h3 className="text-lg font-semibold">Nội dung mới nhất</h3>
          </div>
          <div className="p-6">
            <table className="w-full">
              <thead>
              ...
              <tbody>
                {recentContent.map((content) => (
                  <tr key={content.id} className="border-t border-gray-100">
                    ...
                    <td className="py-3 text-gray-500">{content.date}</td>
                  </tr>
                ))}
              </tbody>
            </table>
